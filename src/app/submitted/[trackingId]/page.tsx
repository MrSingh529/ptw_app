    ...
    <div className="container flex h-[calc(100vh-10rem)] items-center justify-center">
      <Card className="w-full max-w-lg text-center">
        <CardHeader>
          ...
          <CardDescription>
            Your permit request has been submitted and a notification has been sent to the approver.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground pt-4">
            You will be notified of the approver's decision. You can track the status of your request using the link below.
          </p>
        </CardContent>
        <CardFooter>
